...
//    }
    ...
    @objc func crateUI(){
        ...
        self.view.addSubview(myView);
         ...
         backBtn.frame = CGRect(x: 20, y: kNavBarAndStatusBarHeight + 20, width: 70, height:50);
         ...
         myView.frame = CGRect(x: 20, y: calculatorBtn.frame.origin.y + calculatorBtn.frame.size.height + 20, width: kScreenWidth - 40, height: 300);
    }
